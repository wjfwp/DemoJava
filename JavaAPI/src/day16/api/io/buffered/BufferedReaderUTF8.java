...
public class BufferedReaderUTF8 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 2가지 방법
		 * 1. 원본파일의 인코딩을 UTF-8로 변경 -근본적인 방안
		 * 2. 파일의 인코딩형식이 다른면 (한글)이 깨지게 되는데 인코딩을 동일한 형태로 맞춰서 가지고 오면 됩니다. - 임시적인 방안
		 * 
		 * 
		 */
		...
		//Reader rd = new InputStreamReader( fis, "EUC-KR" ); //1바이트 기반 => 2바이트 형식 변경
